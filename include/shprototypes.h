...
extern shellcmd xsh_resumen(pri16);

/* in file xsh_signaln.c*/
extern shellcmd xsh_signaln(pri16);

/* in file xsh_createsleep.c */
extern shellcmd xsh_createsleep(pri16);

/* in file xsh_psready.c */
extern shellcmd xsh_psready(pri16);

/* in file xsh_wait.c */
extern shellcmd xsh_wait(pri16);

/* in file xsh_lab5.c */
extern shellcmd xsh_scheduler(int32, char* []);
extern shellcmd xsh_process(int32, char* []);
