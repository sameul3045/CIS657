...
#define SCHED_RRP 1	 /* Set scheduler to priority based round robin (default)	*/
#define SCHED_FCFS 2 /* Set scheduler to First Come First Served				*/

extern int32 g_xinuSchedulerType; /* Global variable holding the scheduler type value	*/
